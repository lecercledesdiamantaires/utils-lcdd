            ...
            if len(options) >= 3:
                for option3 in options[2]['values']:
                    variant = {
                        ...
                        "price": select_price(price, option3) if product_type in ["Baguecatalogue", "Colliercatalogue", "Braceletcatalogue", "Bouclesdoreillescatalogue"] else price,
                        "weight": weight,
                        "weight_unit": "g",
                ...
                variant = {
                    ...
                    "barcode": "", 
                    "inventory_management": "shopify",
                    "price": select_price(price, option2) if product_type in ["Baguecatalogue", "Colliercatalogue", "Braceletcatalogue", "Bouclesdoreillescatalogue"] else price,
                    "weight": weight,
                    "weight_unit": "g",
                    "inventory_quantity": 999,
                    "old_inventory_quantity": 999,
